...
import { AppleIcon, FrenchFries, RobotIcon, TestTubeIcon } from '@/components/icons';
...
export const BannerSection = () => (
  <section className='relative overflow-x-clip'>
    ...
    <motion.img
      alt='pixel'
      animate={{ x: 0, y: 0 }}
      className='absolute top-1/2 right-8 w-[120px] -translate-y-[300px] sm:right-16 sm:w-[140px] sm:-translate-y-[350px] md:right-20 md:w-[157px] md:-translate-y-[400px] lg:right-32 lg:w-[180px] lg:-translate-y-[450px] xl:right-40'
      initial={{ x: 70, y: -30 }}
    ...
    <motion.img
      alt='pixel'
      animate={{ x: 0, y: 0 }}
      className='absolute top-1/2 -left-[45%] w-[700px] -translate-y-[150px] sm:-left-[40%] sm:w-[800px] sm:-translate-y-[175px] md:-left-[30%] md:w-[941px] md:-translate-y-[200px] lg:-left-[25%] lg:w-[1100px] lg:-translate-y-[250px] xl:-left-[20%]'
      initial={{ x: -70, y: 20 }}
      src='/first-pixel.png'
      transition={{ duration: 0.5 }}
    />
    <motion.img
      alt='pixel'
      animate={{ x: 0, y: 0 }}
      className='absolute top-1/2 -right-[35%] w-[800px] translate-y-[180px] sm:-right-[30%] sm:w-[900px] sm:translate-y-[200px] md:-right-[20%] md:w-[1041px] md:translate-y-[220px] lg:-right-[15%] lg:w-[1200px] lg:translate-y-[260px] xl:-right-[20%]'
      initial={{ x: 70, y: 60 }}
      src='/first-pixel.png'
      transition={{ duration: 0.5 }}
    />
